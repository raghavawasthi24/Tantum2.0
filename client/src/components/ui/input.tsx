  ...
  ({ className, type, startAdornment, endAdornment, ...props }, ref) => {
    ...
    return (
      <>
        {hasAdornment ? (
          <div
            className="w-full flex items-center justify-center gap-2 px-3 h-9 rounded-md border border-input bg-transparent ring-offset-background focus-within:ring-1  focus-within:ring-offset-0 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-50"
